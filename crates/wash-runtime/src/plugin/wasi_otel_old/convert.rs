...
use super::bindings::wasi::otel0_2_0_rc_1::logs::LogRecord as WasiLogRecord;
use super::bindings::wasi::otel0_2_0_rc_1::metrics as wasi_metrics;
use super::bindings::wasi::otel0_2_0_rc_1::tracing as wasi_tracing;
use super::bindings::wasi::otel0_2_0_rc_1::tracing::{
...
pub fn convert_wasi_log_record<R: OtelLogRecord>(
    ...
    if wasi_record.trace_id.is_some() || wasi_record.span_id.is_some() {
        ...
        let flags = wasi_record
            .trace_flags
            .map(|f| {
                if f.contains(super::bindings::wasi::otel0_2_0_rc_1::tracing::TraceFlags::SAMPLED) {
                    TraceFlags::SAMPLED
                } else {
                    TraceFlags::default()
                }
...
fn convert_key_values(
    attrs: &[super::bindings::wasi::otel0_2_0_rc_1::types::KeyValue],
) -> Vec<KeyValue> {
    attrs
        .iter()
