...
const WASI_OTEL_ID: &str = "wasi-otel-old";
...
use bindings::wasi::otel0_2_0_rc_1::tracing::{
...
impl HostPlugin for WasiOtel {
    ...
    async fn on_workload_item_bind<'a>(
        ...
        bindings::wasi::otel0_2_0_rc_1::types::add_to_linker::<_, SharedCtx>(
            component_handle.linker(),
            extract_active_ctx,
        )?;
        bindings::wasi::otel0_2_0_rc_1::tracing::add_to_linker::<_, SharedCtx>(
            component_handle.linker(),
            extract_active_ctx,
        )?;
        bindings::wasi::otel0_2_0_rc_1::metrics::add_to_linker::<_, SharedCtx>(
            component_handle.linker(),
            extract_active_ctx,
        )?;
        bindings::wasi::otel0_2_0_rc_1::logs::add_to_linker::<_, SharedCtx>(
            component_handle.linker(),
            extract_active_ctx,
        )?;
...
// OTel Logs
impl<'a> bindings::wasi::otel0_2_0_rc_1::logs::Host for ActiveCtx<'a> {
    async fn on_emit(
        &mut self,
        data: bindings::wasi::otel0_2_0_rc_1::logs::LogRecord,
    ) -> wasmtime::Result<()> {
...
// OTel Metrics
impl<'a> bindings::wasi::otel0_2_0_rc_1::metrics::Host for ActiveCtx<'a> {
    async fn export(
        &mut self,
        resource_metrics: bindings::wasi::otel0_2_0_rc_1::metrics::ResourceMetrics,
    ) -> wasmtime::Result<Result<(), bindings::wasi::otel0_2_0_rc_1::metrics::Error>> {
        if let Some(plugin) = self.ctx.get_plugin::<WasiOtel>(WASI_OTEL_ID) {
...
// OTel Tracing
impl<'a> bindings::wasi::otel0_2_0_rc_1::tracing::Host for ActiveCtx<'a> {
    async fn on_start(
        &mut self,
        span_context: bindings::wasi::otel0_2_0_rc_1::tracing::SpanContext,
    ) -> wasmtime::Result<()> {
    ...
    async fn on_end(
        &mut self,
        span_data: bindings::wasi::otel0_2_0_rc_1::tracing::SpanData,
    ) -> wasmtime::Result<()> {
        if let Some(plugin) = self.ctx.get_plugin::<WasiOtel>(WASI_OTEL_ID) {
...
impl<'a> bindings::wasi::otel0_2_0_rc_1::types::Host for ActiveCtx<'a> {}
